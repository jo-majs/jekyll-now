...
BR_C = \left( \begin{matrix} ct_C\\ v_B t_C \\ 0 \\ \end{matrix} \right).
$$  
...
$$
AL_B = \left( \begin{matrix} ct\\ 0 \\ v_A t \\ \end{matrix} \right),
AR_B = \left( \begin{matrix} ct\\ L \\ v_A t \\ \end{matrix} \right),
BL_B = \left( \begin{matrix} ct\\ v_B t \\ 0 \\ \end{matrix} \right),
BR_B = \left( \begin{matrix} ct\\ v_B t \\ 0 \\ \end{matrix} \right).
$$  
  
But don't take my word for it, make sure to check it yourself!  
