...
$$
AL = \left( \begin{matrix} ct_{AL}\\ x_{AL} \\ y_{AL} \\ \end{matrix} \right) =
\left( \begin{matrix} ct\\ 0 \\ v_2 t \\ \end{matrix} \right),
AR = \left( \begin{matrix} ct_{AR}\\ x_{AR} \\ y_{AR} \\ \end{matrix} \right) =
\left( \begin{matrix} ct\\ L \\ v_2 t \\ \end{matrix} \right),
$$
We see that at $$t_C = 0$$ the board is indeed passing through the hole. 
