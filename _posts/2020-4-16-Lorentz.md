...
But assuming these results are correct, are you surprised? We know that events which are simultaneous in one frame, don't have to be simultaneous in another. And indeed, we see that what Carl perceives as simultaneous - an event of the Bee's board's end being at certain locations - is not simultaneous from the Bee's point of view. We could have seen it coming but it still seems kind of weird, doesn't it? So let's see how the Bee perceives it.
